...
def read_time(time):
    ...
    #print("initial_temp_strength from forward prop read fn is",initial_temp_strength)
    ...
    ##print("final_temp_strength from forward prop read fn is",final_temp_strength)
...
def strength_time(time,push_certainity,pop_certainity):
    ...
    ##print("initial_strength from forward strength fn is",initial_strength)
...
def strength_time_error(time,error,push_certainity,pop_certainity):
    ...
    ##print("initial_strength is", initial_strength)
...
for i in range(500):
    ...
    #error=np.matrix("0,0;0,0;0,0;-.1,0;-.05,0;-.05,0")
